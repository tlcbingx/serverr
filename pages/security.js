      ...
      <style jsx>
        {`
          @media (max-width: 768px) {
            ...
            .security-trust__container,
            .security-features__container,
            .security-philosophy__container {
            ...
            .security-hero .glass-main {
              padding: 1.5rem !important;
            }
            
            .security-hero .section-subtitle {
              font-size: 1rem !important;
              margin-bottom: 1.5rem !important;
            }
            
            .security-trust .glass-main,
            .security-philosophy .glass-main {
              padding: 2rem !important;
            }
            
            .security-trust .glass-main p,
            .security-philosophy .glass-main p {
              font-size: 1rem !important;
              margin-bottom: 1.5rem !important;
            }
            
            .security-trust .glass-main > div,
            .security-philosophy .glass-main > div {
              padding: 1.5rem !important;
            }
            
            .security-trust .glass-main > div p,
            .security-philosophy .glass-main > div p {
              font-size: 1rem !important;
              margin: 0 !important;
            }
            
            .security-philosophy .glass-main > div p:first-child {
              font-size: 1.1rem !important;
          ...
          @media (max-width: 480px) {
            ...
            .security-trust .glass-main > div p:first-child,
            .security-philosophy .glass-main > div p:first-child {
              font-size: 1rem !important;
            }
          }
